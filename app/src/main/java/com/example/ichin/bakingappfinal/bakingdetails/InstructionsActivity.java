package com.example.ichin.bakingappfinal.bakingdetails;
...
import static com.example.ichin.bakingappfinal.ui.RecipeResponse.IngredientsBean;
...
public class InstructionsActivity extends AppCompatActivity implements InstructionsFragment.InstructionCallBack {
    ...
    public static final String ACTION_DATA_UPDATED = "com.example.ichin.bakingappfinal.ACTION_DATA_UPDATE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SharedPrefUtils.recipeExist(this,recipeId)){
                ...
                if (toggleButton.isChecked()) {
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            try{
                                ...
                                SharedPrefUtils.setSavedIngredientName(InstructionsActivity.this,name);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            SharedPrefUtils.setSavedIngredientName(InstructionsActivity.this,"");
                            InstructionsActivity.this.getContentResolver().delete(RecipeProvider.RecipeIngredients.CONTENT_URI,null,null);
                            InstructionsActivity.this.getContentResolver().delete(RecipeProvider.RecipeList.CONTENT_URI,null,null);
                            InstructionsActivity.this.sendBroadcast(recipeDataUpdated);
                        }
